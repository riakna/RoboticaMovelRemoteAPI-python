...
class Simulator:
    ...
    def initVisionSensorImageStream(self, sensorHandle):
    ...
    def getVisionSensorImageBlock(self, sensorHandle):
        returnCode, resolution, image = vrep.simxGetVisionSensorImage(self.clientId, sensorHandle, 0, vrep.simx_opmode_blocking)
        if (returnCode != vrep.simx_return_ok):
            sys.exit("Unable to get image in blocking mode")
